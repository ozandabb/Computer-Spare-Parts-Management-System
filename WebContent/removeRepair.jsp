...
<!--//================Header start==============//-->  
		...
		<!--//================remove repair section start==============//-->
		<section id="main-sec">
			<div class="o-container">
			
				<form action="removeRepairServlet" method="POST">
				
				<h2 style="font-size:30px; text-align:center; color:white;">Remove an item from repair table</h2><br>
				
				<input name="itemId" type="text" placeholder="Item ID.. " required>
				
				<!-- <button name="login" class="login-button" type="POST">Login</button> -->
				<input type = "submit" class = "login-button" value = "Remove from repair">

				</form>
			
			</div>
		</section>
		<!--//================remove repair section end==============//-->

            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 margin-small">
                        <div class="service-box">
                            <div class="service-content">
                                <img src="assets/img/all/gallery-1.jpg" alt="">
                                <h4><a href="#">Desktop Casings</a></h4><br>
                                <a href="desktop_casing.jsp" class="itg-button active">Browse >></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-12 margin-small">
                        <div class="service-box">
                            <div class="service-content">
                                <img src="assets/img/all/gallery-6.jpg" alt="">
                                <h4><a href="#">Cooling Fans </a></h4>
                                <br>
                                <a href="desktop_casing.jsp" class="itg-button active">Browse >></a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 margin-small">
                        <div class="service-box">
                            <div class="service-content">
                                <img src="assets/img/all/gallery-5.jpg" alt="">
                                <h4><a href="#">Motherboards</a></h4>
                                <br>
                                <a href="desktop_casing.jsp" class="itg-button active">Browse >></a>
                            </div>
                        </div>
				...
				<div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 margin-small">
                        <div class="service-box">
                            <div class="service-content">
                                <img src="assets/img/all/gallery-3.jpg" alt="">
                                <h4><a href="#">Graphic Cards</a></h4>
                                <br>
                                <a href="desktop_casing.jsp" class="itg-button active">Browse >></a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 margin-small">
                        <div class="service-box">
                            <div class="service-content">
                                <img src="assets/img/all/gallery-4.jpg" alt="">
                                <h4><a href="#">Power Supply Units</a></h4>
                                <br>
                                <a href="desktop_casing.jsp" class="itg-button active">Browse >></a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 margin-small">
                        <div class="service-box">
                            <div class="service-content">
                                <img src="assets/img/all/gallery-2.jpg" alt="">
                                <h4><a href="#">RAM</a></h4>
                                <br>
                                <a href="desktop_casing.jsp" class="itg-button active">Browse >></a>
                            </div>

                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 margin-small">
                        <div class="service-box">
                            <div class="service-content">
                                ...
                                <h4><a href="#">Add Reparing Item</a></h4><br>
								<p>Add repairing items from the customer.</p><br>
                                <a href="addReparing.jsp" class="itg-button active">Start</a>
                            </div>
                        </div>
                    </div>
					<div class="col-md-4 col-sm-6 col-xs-12 margin-small">
                        <div class="service-box">
                            <div class="service-content">
                                ...
                                <h4><a href="#">Repairing Status</a></h4><br>
								<p>display the status of the reparing works. Employee can add a tick.</p><br>
                                <a href="repairStatus.jsp" class="itg-button active">Start</a>
                            </div>
                        </div>
                    </div>
					<div class="col-md-4 col-sm-6 col-xs-12 margin-small">
                        <div class="service-box">
                            <div class="service-content">
                                ...
                                <h4><a href="#">Buy Items</a></h4><br>
								<p>Employee can buy items for the customer from the store.</p><br>
                                <a href="desktop_Spare.jsp" class="itg-button active">Start</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 col-xs-12 margin-small">
                        <div class="service-box">
                            <div class="service-content">
                                ...
                                <h4><a href="#">View Repair</a></h4><br>
								<p>View repair table so employee can return repaired items</p><br>
                                <a href="viewRepairServlet" class="itg-button active">Show</a>
                            </div>
                        </div>
                    </div>

...
<html lang="en">
    <head>
		...
		<link href="assets/css/des_casi.css" rel="stylesheet">
    ...
    %>
     ...
     <!--//================Header start==============//-->  
		...
		<section class="block" color="gray">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="portfolio-mini-sec">
						<div class="row">
                            ...
                            <h3>Desktop Casings</h3>
                        </div>
							<div class="col-md-3">
								<div class="mini-portfolio">
									 <img src="assets/img/all/d1.jpg" alt="">
									<div class="portfolio-info">
										<span>Fusion</span>
										<h3>1000 strong | 978gtR perform</h3>
										<h2>DDR56 with genuin</h2>
										<ul>
											<a href="order.jsp" class="itg-button active">Order </a>
										</ul>
									</div>
								</div><!-- Portfolio Box -->
							</div>
							<div class="col-md-3">
								<div class="mini-portfolio">
									 <img src="assets/img/all/d2.jpg" alt="">
									<div class="portfolio-info">
										<span>Ali baba</span>
										<h3>1000 strong | 978gtR perform</h3>
										<h2>mnbv with Part</h2>
										<ul>
											<a href="order.jsp" class="itg-button active">Order</a>
										</ul>
									</div>
							...
							<div class="col-md-3">
								<div class="mini-portfolio">
									 <img src="assets/img/all/d3.jpg" alt="">
									<div class="portfolio-info">
										<span>Ishu</span>
										<h3>345 strong | 978gtR perform</h3>
										<h2>dd with Size</h2>
										<ul>
											<a href="order.jsp" class="itg-button active">Order</a>
										</ul>
							...
							<div class="col-md-3">
								<div class="mini-portfolio">
									 <img src="assets/img/all/d4.jpg" alt="">
									<div class="portfolio-info">
										<span>Yaka</span>
										<h3>1000 strong | 978gtR perform</h3>
										<h2>fds23 with solid</h2>
										<ul>
											<a href="order.jsp" class="itg-button active">Order</a>
										</ul>
									</div>
							...
							<div class="col-md-3">
								<div class="mini-portfolio">
									 <img src="assets/img/all/d5.jpg" alt="">
									<div class="portfolio-info">
										<span>Gemba</span>
										<h3>ds54 strong | 978gtR perform</h3>
										<h2>DDR56 with genuin</h2>
										<ul>
											<a href="order.jsp" class="itg-button active">Order</a>
										</ul>
							...
							<div class="col-md-3">
								<div class="mini-portfolio">
									 <img src="assets/img/all/d6.jpg" alt="">
									<div class="portfolio-info">
										<span>Donkey</span>
										<h3>1000 strong | 978gtR perform</h3>
										<h2>DDR56 with genuin</h2>
							...
							<div class="col-md-3">
								<div class="mini-portfolio">
									 <img src="assets/img/all/d7.jpg" alt="">
									<div class="portfolio-info">
										<span>FoxHill</span>
										<h3>s213 strong | 978gtR perform</h3>
										<h2>fg65 with real</h2>
										<ul>
											<a href="order.jsp" class="itg-button active">Order</a>
										</ul>
									</div>
							...
							<div class="col-md-3">
								<div class="mini-portfolio">
									 <img src="assets/img/all/d8.jpg" alt="">
									<div class="portfolio-info">
										<span>Fusion</span>
										<h3>1000 strong | 978gtR perform</h3>
										<h2>DDR56 with genuin</h2>

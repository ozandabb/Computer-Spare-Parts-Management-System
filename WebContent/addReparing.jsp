...
<body id = "topbody">
    ...
    %>
		...
		<form action="repairServlet" method="POST">
			...
			<p>Enter customer details for confirm to repairing.</p><br>
			
			<input type="text" placeholder="Full Name " name="name" class="pname" required>
			<input type="text" placeholder="Address  " name="address" class="pname" required>
			<input type="text" placeholder="Phone Number  " name="contactNumber" class="pname" required>
			<input type="text" placeholder="Date  " name="date" class="pname" required>
			
			<h4>Item Details</h4>
			<p>Enter item details for confirm item .</p><br>
			
			<input type="text" placeholder="Item ID  " name="itemId" class="pname" required>
			<input type="text" placeholder="Description" name="des" class="pname" required>
			
			<h4>Payment Details</h4>
			<p>Enter Payment details for confirm payment options .</p><br>
			
			<select name="ptype" class="ptype" required>
				<option value="cash">Cash</option>
				<option value="card">Card</option>
			</select>
			<input type="text" placeholder="Amount" name="amount" class="pname" required>

			<!-- <a href=".html" class="itg-button active">Add</a> -->

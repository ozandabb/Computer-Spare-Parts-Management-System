						...
						<div class="row">
								...
								<div class="single-product-tabs">
									<div class="tab-content">
										<div id="tab1" class="tab-pane fade in active">
											<img src="http://placehold.it/570x615" alt="" />
										</div>
									...
									<ul class="nav nav-tabs">
										<li><a data-toggle="tab" href="#tab1">
											<img src="http://placehold.it/170x153" alt="" /></a>
										</li>
										<li><a data-toggle="tab" href="#tab2">
											<img src="http://placehold.it/170x153" alt="" /></a>
										</li>
										<li class="active"><a data-toggle="tab" href="#tab3">
											<img src="http://placehold.it/170x153" alt="" /></a>
										</li>
									</ul>
								</div>
							...
							<div class="col-md-6">
								<div class="single-product-infos">
									<h2>Fusion | 1000 strong with 978gtR perform<br/></h2>13 available
									...
									<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euis sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euis</p>
									<div class="c-input-number">
										<span><input id="box1" type="text" class="manual-adjust" value="0"/></span>
									</div>
									<a href="payment.jsp" class="itg-button active">Buy Now</a>
									<a href="cart.html" class="itg-button active">Add to Cart</a>
								</div>
							</div>
						</div>
					</div>

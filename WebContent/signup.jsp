	...
	<!--//================Header start==============//-->  
		...
		<section id="main-sec">
			<div class="o-container">
				...
				<h2 style="font-size:30px; text-align:center; color:white; margin:-70px 0 0 0;">Sign Up</h2><br>
				...
				<p style="font-size:11px; text-align:center;">Already a member? <a href="login_reg.html">Log In</a></p>
